...
/**
 * A linked list implementation. Operations include: add, remove (single and
 * array), indexOf and toString.
 * 
...
public class LinkedList<T extends Comparable<T>> {
  ...
  /**
   * Find a node in the linked list. This relies on the fact that the specific
   * class of inputData will have a meaningful equals() method.
   * 
   * @param inputData The element to look for.
  ...
  /**
   * Delete a node from the linked list. This relies on the fact that the
   * specific class of inputData will have a meaningful equals() method. If the
   * object to remove is not found, nothing will happen.
   * 
  ...
  /**
   * Add another linked list to the end of this linked list
   * 
  ...
  public void concatenate(LinkedList<T> list) {
    ...
    this.lastNode.next = list.firstNode;
    this.size += list.size;
  }

  /**
   * An inner class to be used only for the LinkedList class. The ListNode class
   * is basically a Java Bean for data and next.
   * 
   * @author Daniel Acton (code@danielacton.com)
   *
   */
