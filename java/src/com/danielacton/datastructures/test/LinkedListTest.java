...
public class LinkedListTest extends TestCase {
	...
	/**
	 * Test that the LinkedList is constructed. 
	 * Result is a list with 0 elements.
	 */
	 ...
	 * Result is a list with 1 element with a certain value
	 */
	 ...
	 * Result is a list with 4 elements with certain values
	 */
	 ...
	 * Result is a list with 1 elements with a certain value
	 */
	 ...
	 * Result is a list with many elements with certain values
	 */
	...
	/**
	 * Test that removing a single element from the start of the list works
	 * Result is a list moved "one to the left" with first item replaced
	 */
	...
	/**
	 * Test that removing a single element from anywhere in the list works
	 * Result is a list moved "one to the left" with item replaced
	 */
	...
	/**
	 * Test that removing a single element from the end of the list works
	 * Result is a list that is 1 element shorter
	 */
	...
	/**
	 * Test that removing many elements from the start of the list works
	 * Result is a list moved "N to the left"
	 */
	...
	/**
	 * Test that removing many elements from the end of the list works
	 * Result is a list that is N elements shorter
	 */
	...
	/**
	 * Test that removing many elements from the end of the list works
	 * Result is a list that is N elements shorter, keeping start and end bits
	 */
	...
	/**
	 * Test that searching for an element works
	 * Result is the correct position of the elements added
	 */
	...
	/**
	 * Concatenate lists A and B where A is empty
	 * Result is B
	 */
	...
	/**
	 * Concatenate lists A and B where B is empty
	 * Result is A
	 */
	...
	/**
	 * Concatenate lists A and B where neither is empty
	 * Result is A+B
	 */
	...
	/**
	 * Concatenate lists A and B where both are empty
	 * Result is empty
	 */
